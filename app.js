...
async function initApp() {
  try {
    setAppLoadingStatus('Cargando interfaz...');
    await loadViews();
    setAppLoadingStatus('Preparando navegacion...');
    buildMarquee();
    updateNav();
    setAppLoadingStatus('Sincronizando perfil y datos...');
    await bootstrapSupabaseData();
    setAppLoadingStatus('Revisando estado de pagos...');
    await checkMpReturn();
    setAppReady();
