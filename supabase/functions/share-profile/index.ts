...
<title>Recomendapp - ReconocÃ© quien te atendiÃ³ bien</title>
<meta name="description" content="Descubri perfiles con recomendaciones visibles, resenas reales y reconocimiento economico en Recomendapp.">
<meta property="og:title" content="Recomendapp - ReconocÃ© quien te atendiÃ³ bien">
<meta property="og:description" content="Descubri perfiles con recomendaciones visibles, resenas reales y reconocimiento economico en Recomendapp.">
<meta property="og:type" content="website">
<meta property="og:url" content="https://recomendapp.netlify.app/">
<meta property="og:image" content="">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Recomendapp - ReconocÃ© quien te atendiÃ³ bien">
<meta name="twitter:description" content="Descubri perfiles con recomendaciones visibles, resenas reales y reconocimiento economico en Recomendapp.">
<meta name="twitter:image" content="">
<link rel="canonical" href="https://recomendapp.netlify.app/">
...
<div class="modal-overlay" id="replyModal">
  <div class="modal">
    <h3>Responder reseÃ±a</h3>
    <p class="modal-sub">Tu respuesta serÃ¡ visible pÃºblicamente en el perfil</p>
    ...
    <div class="field">
      ...
      <textarea class="field-textarea" id="replyText" placeholder="EscribÃ­ tu respuesta..."></textarea>
    </div>
...
<div class="modal-overlay" id="mpConfigModal">
  <div class="modal">
    ...
    <p class="modal-sub">IngresÃ¡ tus credenciales para activar los pagos reales en tu perfil.</p>
    <div class="mp-info-box">
      <span class="icon">Info</span>
      <div>EncontrÃ¡ tus credenciales en <strong>mercadopago.com.ar</strong> -> Tu cuenta -> Credenciales. UsÃ¡ las credenciales de <strong>ProducciÃ³n</strong> para pagos reales.</div>
    </div>
    <div class="field">
    ...
    <div class="field">
      ...
      <select class="field-select field-input" id="mpModeSelect">
        ...
        <option value="production">ProducciÃ³n (pagos reales)</option>
      </select>
    </div>
    <div class="modal-actions">
